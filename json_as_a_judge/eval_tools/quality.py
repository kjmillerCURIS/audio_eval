...
from json_as_a_judge.libs.DNSMOS.dnsmos_single import ComputeScore, SAMPLING_RATE
...
dnsmos_scorer = ComputeScore(
        model_path="json_as_a_judge/models/DNSMOS/sig_bak_ovr.onnx",
        p_model_path="json_as_a_judge/models/DNSMOS/p_sig_bak_ovr.onnx",
        p808_model_path="json_as_a_judge/models/DNSMOS/model_v8.onnx")
