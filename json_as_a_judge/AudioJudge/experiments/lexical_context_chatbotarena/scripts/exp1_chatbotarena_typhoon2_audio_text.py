    ...
    for i in tqdm(range(num_done, len(data))):
        ...
        conversation = [
            ...
            },
            {
                "role": "user",
                "content": [
                    {"type": "text", "text": prompt_template_question},
                    {
                        "type": "audio",
            ...
            {"role": "user", "content": [{"type": "text", "text": prompt_response}]},
        ]
        # Generate the response
        x = model.generate(
...
def main():
    ...
    # usage: python scripts.exp1_chatbotarena_typhoon2_audio_text.py --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/audio-text-typhoon2.jsonl --order ab
    # usage: python scripts.exp1_chatbotarena_typhoon2_audio_text.py --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/audio-text-typhoon2_BA.jsonl --order ba
