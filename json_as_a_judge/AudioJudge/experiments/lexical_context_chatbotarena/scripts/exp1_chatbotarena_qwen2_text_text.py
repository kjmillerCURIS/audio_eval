...
def main():
    ...
    # usage: python -m scripts.exp1_chatbotarena_qwen2_text_text.py --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-qwen2.jsonl --order ab
    # usage: python -m scripts.exp1_chatbotarena_qwen2_text_text.py --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-qwen2_BA.jsonl --order ba
