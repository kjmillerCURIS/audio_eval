...
def main():
    ...
    # usage: python -m scripts.exp1_chatbotarena_gemini_text_text.py --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-gemini1.5flash.jsonl --order ab
    # usage: python -m scripts.exp1_chatbotarena_gemini_text_text.py --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-gemini1.5flash_BA.jsonl --order ba
    ...
    # usage: python -m scripts.exp1_chatbotarena_gemini_text_text --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-gemini2.5flash.jsonl --order ab
    # usage: python -m scripts.exp1_chatbotarena_gemini_text_text --data_path data/chatbot-arena-spoken-1turn-english-difference-voices.json --output_path experiments/chatbot-arena-7824/text-text-gemini2.5flash_BA.jsonl --order ba
